...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var _a, NODE_ENV, PORT, ORIGIN_DEV, ORIGIN_PROD, app, swaggerConfig, document;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = process.env, NODE_ENV = _a.NODE_ENV, PORT = _a.PORT, ORIGIN_DEV = _a.ORIGIN_DEV, ORIGIN_PROD = _a.ORIGIN_PROD;
                ...
                case 1:
                    ...
                    return [4 /*yield*/, app.listen(PORT || 8080, function () {
